...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/varsha-s-s-3b8464305", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://twitter.com/ShaSha42600", label: "Twitter" },
    { icon: <Youtube size={18} />, href: "https://t.me/Varsha7426", label: "Telegram" },
    { icon: <Github size={18} />, href: "https://github.com/varsha4726", label: "GitHub" },
  ];

  const quickLinks = [
    { name: "Home", href: "#HeroSection" },
    { name: "About", href: "#AboutSection" },
    { name: "Work", href: "#ProjectsSection" },
    { name: "Contact", href: "#ContactSection" },
  ];

  const contactInfo = [
    { icon: <Mail size={16} />, text: "varshasuresh7426@gmail.com", href: "mailto:varshasuresh7426@gmail.com" },
    { icon: <Phone size={16} />, text: " +91 9080335364", href: "tel:+ +91 9080335364" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">VARSHA</h3>
          ...
          >
            <div>
              <p>© {currentYear} Varsha. All rights reserved.</p>
            </div>
