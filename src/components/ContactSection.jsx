...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xzdjeepy', {
        method: 'POST',
        headers: {
      ...
      toast({
        ...
        description: "Please try again or email me directly at varshasuresh7426@gmail.com",
        variant: "destructive"
      });
    } finally {
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/varsha-s-s-3b8464305",
                  },
                  {
                    icon: Twitter,
                    label: "Twitter",
                    url: "https://twitter.com/ShaSha42600",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/varsha4726",
                  },
                  {
                    icon: Instagram,
                    label: "Telegram",
                    url: "https://t.me/Varsha7426",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
